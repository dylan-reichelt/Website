var Typer = function(element) {
  ...
  this.delay = element.dataset.delay || "100-200";
...
Typer.prototype.doTyping = function() {
  ...
  if (this.cursor) {
    ...
    this.cursor.interval = setInterval(() => this.cursor.updateBlinkState(), 800);
  }
  ...
  }, atWordEnd ? this.deleteDelay : Math.floor(Math.random() * (max - min + 1)) + min);
};
...
var Cursor = function(element) {
  ...
  this.interval = setInterval(() => this.updateBlinkState(), 800);
}
